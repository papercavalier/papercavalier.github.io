$(function() {
  ...
  function init() {
    ...
    //TEST
    /*
    var geometry = new THREE.SphereGeometry( 4, 4, 7, false );
    var material = new THREE.MeshBasicMaterial( { map: THREE.ImageUtils.loadTexture( 'examples/textures/land_ocean_ice_cloud_2048.jpg' ) , doubleSided: false });
